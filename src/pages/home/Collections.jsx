    ...
    <div className='bg-[url("/images/collection-bg.png")] bg-cover bg-center bg-no-repeat xl:px-28 px-4 my-20'>
      <div className="h-[580px] flex justify-between md:flex-row items-center">
        ...
        <div className="md:w-1/2 ">
          ...
          <button className='capitalize px-6 py-2 bg-white text-black font-normal font-primary text-center hover:scale-105 transition-all duration-300'>See Collections</button>
        </div>
      </div>
    </div>
  )
